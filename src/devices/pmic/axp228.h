...
#define AXP228_DEF_DDC2_VOL             1250000 /* VAL(uV) = 0: 0.60 ~ 1.54V, Step 20 mV, default(OTP) = 1.25V */
#define AXP228_DEF_DDC3_VOL             1100000 /* VAL(uV) = 0: 0.60 ~ 1.86V, Step 20 mV, default(OTP) = 1.1V */
