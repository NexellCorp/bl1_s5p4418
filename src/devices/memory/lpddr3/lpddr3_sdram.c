...
static void get_dram_information(struct dram_device_info *me)
{
	...
	me->bank_num	= (LPDDR3_BANK_NUM);
	me->row_num	= (LPDDR3_ROW_NUM + 12);
	me->column_num	= (LPDDR3_COL_NUM +  7);
	...
	me->chip_size	= (((me->bank_size * (1 << me->bank_num))
				* LPDDR3_BUS_WIDTH)/ 1024 / 1024);		// Unit: MB
	me->sdram_size	= (me->chip_size * (LPDDR3_CS_NUM * 32 / LPDDR3_BUS_WIDTH));
#else
