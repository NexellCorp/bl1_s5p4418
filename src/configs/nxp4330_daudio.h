 ...
 */
#ifndef __S5P4418_DAUDIO_H__
#define __S5P4418_DAUDIO_H__

#include <clock.h>
#include <freq.h>

/* system clock macro */
#define CONFIG_S5P_PLL0_FREQ 742 // 742.5MHz - for 720p30 TVI
#define CONFIG_S5P_PLL1_FREQ 800
#define CONFIG_S5P_PLL2_FREQ 614
#define CONFIG_S5P_PLL3_FREQ 800

// CPUDVOREG
#define CONFIG_S5P_PLLx_DVO0                                                   \
	((CLKSRC_PLL_1 << CLKSRC_BITPOS) | ((1 - 1) << DVO0_BITPOS) |          \
	 ((4 - 1) << DVO1_BITPOS))
// BUSDVOREG
#define CONFIG_S5P_PLLx_DVO1                                                   \
	((CLKSRC_PLL_0 << CLKSRC_BITPOS) | ((2 - 1) << DVO0_BITPOS) |          \
	 ((2 - 1) << DVO1_BITPOS))
// MEMDVOREG
#define CONFIG_S5P_PLLx_DVO2                                                   \
	((CLKSRC_PLL_0 << CLKSRC_BITPOS) | ((1 - 1) << DVO0_BITPOS) |          \
	 ((1 - 1) << DVO1_BITPOS) | ((2 - 1) << DVO2_BITPOS) |                 \
	 ((2 - 1) << DVO3_BITPOS))

#define CONFIG_S5P_PLLx_DVO3                                                   \
	((CLKSRC_PLL_0 << CLKSRC_BITPOS) | ((2 - 1) << DVO0_BITPOS) |          \
	 ((2 - 1) << DVO1_BITPOS))

#define CONFIG_S5P_PLLx_DVO4                                                   \
	((CLKSRC_PLL_0 << CLKSRC_BITPOS) | ((2 - 1) << DVO0_BITPOS) |          \
	 ((2 - 1) << DVO1_BITPOS))
...
#define CONFIG_DDR3_CHIP_PERSIZE                                               \
	((((1 << CONFIG_DDR3_ROW_NUM) / 8) * (1 << CONFIG_DDR3_COLUMN_NUM) *   \
	  (1 << CONFIG_DDR3_BANK_NUM) *                                        \
	  CONFIG_DDR3_BUS_WIDTH)) // Chip Per Byte Size

#define CONFIG_DDR3_CS_PERSIZE                                                 \
	(CONFIG_DDR3_CHIP_PERSIZE *                                            \
	 (32 / CONFIG_DDR3_BUS_WIDTH)) // CS Per Byte Size

#define CONFIG_DDR3_MEMSIZE                                                    \
	((((1 << CONFIG_DDR3_ROW_NUM) / 8) * (1 << CONFIG_DDR3_COLUMN_NUM) *   \
	  (1 << CONFIG_DDR3_BANK_NUM) *                                        \
...
#define CONFIG_DRAM_MR1_RTT_Nom                                                \
	2 // MR1_RTT_Nom - 001: RZQ/4, 010: RZQ/2, 011: RZQ/6, 100: RZQ/12, 101:
	  // RZQ/8
#define CONFIG_DRAM_MR2_RTT_WR                                                 \
	1 // MR2_RTT_WR - 0: ODT disable, 1: RZQ/4, 2: RZQ/2
...
#define CONFIG_DDR3_LVLTR_EN                                                   \
	(CONFIG_DDR3_WRITE_LVL_EN << 0) | (CONFIG_DDR3_GATE_LVL_EN << 2) |     \
	    (CONFIG_DDR3_READ_DQ_EN << 3) | (CONFIG_DDR3_WRITE_DQ_EN << 4)
...
#endif // #ifndef __S5P4418_DAUDIO_H__
