 ...
 */
#ifndef __S5P4418_AVN_REF_H__
#define __S5P4418_AVN_REF_H__
...
#define CONFIG_S5P_PLLx_DVO3			((CLKSRC_PLL_0 << CLKSRC_BITPOS) | 	/* PLL Select */				 \
						((2 - 1) << DVO0_BITPOS)	 | 	/*GR3DBCLK ==> GPU bus & core (max 333MHz) */\
						((2 - 1) << DVO1_BITPOS))		/* GR3DPCLK ==> not used */


#define CONFIG_S5P_PLLx_DVO4			((CLKSRC_PLL_0 << CLKSRC_BITPOS) | 	/*PLL Select */					    \
